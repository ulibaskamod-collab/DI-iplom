  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-white/50">Добро пожаловать, {session?.user?.email}</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
        {statsCards.map((stat) => (
          <div key={stat.title} className={`bg-gradient-to-br from-${stat.color}-500/20 to-${stat.color}-600/10 rounded-2xl p-4 border border-${stat.color}-500/30`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/admin/zodiac" className="group bg-white/5 rounded-2xl p-6 border border-white/10 hover:border-pink-500/50 transition">
        ...
        <Link href="/admin/clothing" className="group bg-white/5 rounded-2xl p-6 border border-white/10 hover:border-pink-500/50 transition">
        ...
        <Link href="/admin/designers" className="group bg-white/5 rounded-2xl p-6 border border-white/10 hover:border-pink-500/50 transition">
        ...
        <Link href="/admin/users" className="group bg-white/5 rounded-2xl p-6 border border-white/10 hover:border-pink-500/50 transition">
        ...
        <Link href="/admin/favorites" className="group bg-white/5 rounded-2xl p-6 border border-white/10 hover:border-pink-500/50 transition">
